...
function App() {
  ...
  const { changeHamburgerVisibility } = useHamburgerStore(state => ({changeHamburgerVisibility: state.changeHamburgerVisibility}));
  const {authTokens, updateToken} = useUserCredentials(state => ({authTokens: state.authTokens, updateToken: state.updateToken}));
