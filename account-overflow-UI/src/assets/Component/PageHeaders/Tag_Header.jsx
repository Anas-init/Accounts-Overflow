...
const Tag_Header = ({filterTags}) => {
  return (
    <div className='w-full h-max flex flex-col gap-4 justify-center p-3 pt-6'>
      ...
      <input className='max-[1000px]:w-[40%] max-[600px]:w-[80%] border-2 border-gray-300 px-4 py-1 rounded w-[25%]' placeholder='Filter by tag name' type="text" name="" id="" onChange={filterTags} />
